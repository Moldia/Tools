...
%% import data
data = importdata('QT_0.3_0.01_details.csv',',',1);
pos = data.data(:,1:2);
...
idx_A = find(strcmp('PDGFRA',name_uni));
idx_B = find(strcmp('PDGFRB',name_uni));
...
name_test = find(strcmp('HES1',name_uni));
...
save('Neighbor.mat','a','random_AB','NN_idx','name_uni','name_rest','NN_hist_rate');
