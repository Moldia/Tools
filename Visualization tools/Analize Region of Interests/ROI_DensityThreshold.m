...
bandwidth = 300;
density_threshold = .05;   % between 0 and 1, if 1, automatic thresholding
area_threshold = 500;     % minimal area for a segmented region, in original scale

show_image = 1; % show background image for plotting AND show ROI on top of the image
output_directory = 'E:\PROOOJECTS\test_dataset\ROI_DensityThreshold';
