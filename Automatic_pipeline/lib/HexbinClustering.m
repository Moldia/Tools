...
%% modify here
hexagon_radius = 300;   % in pixel
decoded_file = 'E:\Whole_organoid_pseudoAnchor_v5\Decoding\QT_0.7_details_noNNNN.csv';
num_clusters = 5;
output_directory = 'E:\Whole_organoid_pseudoAnchor_v5\Decoding';
