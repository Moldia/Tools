...
function Noanchor_automatic_function(PATH,OUTPATH, FILE_PREFIX,FILE_SUFIX,ntiles,ncyc,anchorchannel)
...
create_anchor (PATH,FILE_PREFIX, FILE_SUFIX,tile,cyc,OUTPATH,anchorchannel)
...
function create_anchor (PATH,FILE_PREFIX, FILE_SUFIX,tile,cyc,OUTPATH,anchorchannel)
list=1:6
list=list(list~=anchorchannel)
flodap = imread(strcat(PATH, FILE_PREFIX,num2str(list(1)),'\tile',num2str(tile),'.tif'));
flo1 = imread(strcat(PATH, FILE_PREFIX,num2str(list(2)),'\tile',num2str(tile),'.tif'));
flo2 = imread(strcat(PATH, FILE_PREFIX,num2str(list(3)),'\tile',num2str(tile),'.tif'));
flo3 = imread(strcat(PATH, FILE_PREFIX,num2str(list(4)),'\tile',num2str(tile),'.tif'));
flo4 = imread(strcat(PATH, FILE_PREFIX,num2str(list(5)),'\tile',num2str(tile),'.tif'));
flo5 = imread(strcat(PATH, FILE_PREFIX,num2str(anchorchannel),'\tile',num2str(tile),'.tif'));
 ...
 flo_top5= imtophat(flo5,strel('disk', 2));
 th=100;
...
imwrite(flo5, strcat(OUTPATH,'Tile',num2str(tile),'_cyc_',num2str(cyc),'_CH_6',FILE_SUFIX));
end
