PATH='E:\HB_TEST1\Section1\Aligned\'
OUTPATH='E:\HB_TEST1\Section1\anchor\'
FILE_PREFIX='190917_msSBH_02_rd6cy1(1)_t1.tif' %IGNORE
FILE_SUFIX='_ORG.tif'
filenames={
    'Base 1',
    'Base 2',
...
FILE_SUFIX=['_ORG.tif']    
FILE_PREFIX=strcat(filenames(cyc),'_c')
class(FILE_PREFIX)
