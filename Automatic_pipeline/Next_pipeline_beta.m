...
p.input_folder='G:\msHCA_10'; %Folder where  CZI files are located
p.rawfiles={
...
p.background_image = [p.out_folder,'\Align\Base_1_aligned-1.tif']; %Select background image if desired. Otherwise, it takes your Base 1 DAPI
p.I_want_to_plot_on_white_backgound = 0; %1 plots on white background
t.tile_size = 1000; %Modify tile size in tiling
pixel_size=7;

%IMPORTANT:Note that your Metadata file derived from ZEISS needs to be
%removed or to have a different name.
