...
%% modify here
hexbin_counts = 'K:\Organoid_method_development\Organoids_erik\Organoid3_Output\pooled_bincounts_count.csv';  % already binned data (pooled or not), requires header, compatible with output from BatchHexBin
hexbin_position = 'K:\Organoid_method_development\Organoids_erik\Organoid3_Output\pooled_bincounts_binpos.csv';    % bin position file generated at the same time as bin count file
hexbin_size = 200;   % in piexels, if single-cell data use hexbin_size = 0
output_directory = 'K:\Organoid_method_development\Organoids_erik\Organoid3_Output';
