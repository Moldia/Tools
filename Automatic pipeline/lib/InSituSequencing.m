...
% Tiling
    ...
    t.folder_image = 'L:\Processing hmHCA_10_sect2_big\anchor'; % preferably full path name
    ...
    t.CSV_filename_prefix = ['L:\Processing hmHCA_10_sect2_big\anchor\Tiledm',num2str(em),'_withanchor_ALL'];
%----------------------------
% Decoding
