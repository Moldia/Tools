...
function CellProfilerInMatlab_function_3(folder,PREFIX,INTERFIX,SUFIX,TYPE,tiles,outputdirect,ncyc,num_pixels)
...
disp(size(fres1));
freqs=fres1(:,2);
fres1=fres1(freqs>num_pixels,:);
disp(size(fres1));

blobs=unique(fres1(:,1));
blobs = blobs(blobs~=0);
