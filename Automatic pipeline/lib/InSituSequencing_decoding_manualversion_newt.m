...
% Decoding
%[0,0,7,9,8,6]
    d.input_file = 'F:\ISS_Colon Cancer_FF_51516T_Data Analysis_13062019\CP Output FF51516T NEW\blobs.csv';
    ...
    d.num_hybs = 4;
    d.taglist = 'F:\ISS_Colon Cancer_FF_51516T_Data Analysis_13062019\taglist.csv';   % old .m taglist or .csv file with columns: code, name, symbol(optional), no header
    d.csv_file_contain_tile_position = 'F:\ISS_Colon Cancer_FF_51516T_Data Analysis_13062019\Aligned-Colon_FF51516T\1\Aligned_Images_Rigid\Tiled.csv';
    d.output_directory = 'K:\iss-analysis-master\lib\omero\bfmatlab\PreprocessingERIK3\Cellprofiler1';   
    % options
...
%----------------------------
% Plotting
    p.background_image = 'L:\Processing hmHCA_10_sect2_big\Base_1_c1m1_ORG.tif'; 
