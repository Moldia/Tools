...
out_fold='E:\HB_TEST1\Section1\Export';   %Select an output folder, that will be generated
...
d.General_Alignment_ACGT_column_number = [0,0,3,5,4,2]; %Add columns of A ,C ,G and T in this order
...
if run_alignment_YN == 1;
    imregcorr_alignment_function_customized(nbases_ali,nchannels_ali, input_folder_ali,...
