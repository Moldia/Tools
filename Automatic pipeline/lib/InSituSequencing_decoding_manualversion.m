...
% Decoding
%[0,0,7,9,8,6]
    d.input_file = 'L:\Processing hmHCA_10_sect2_big\decoding_1\blobs.csv';
    ...
    d.num_hybs = 5;
    d.taglist = 'E:\hm_brain_SBH_small\taglist_human120.csv';   % old .m taglist or .csv file with columns: code, name, symbol(optional), no header
    d.csv_file_contain_tile_position = 'L:\Processing hmHCA_10_sect2_big\anchor\Tiledm1_withanchor_ALL.csv';
    d.output_directory = 'L:\Processing hmHCA_10_sect2_big\decoding_1\decoding';   
    % options
